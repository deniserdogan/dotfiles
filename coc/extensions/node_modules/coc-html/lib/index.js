...
const tagClosing_1 = __webpack_require__(46);
var TagCloseRequest;
...
function realActivate(context, filetypes) {
    ...
    let dataPaths = [
        ...customData_1.getCustomDataPathsInAllWorkspaces(),
    ...
    client.onReady().then(() => {
        context.subscriptions.push(coc_nvim_1.languages.registerSelectionRangeProvider(selector, {
            provideSelectionRanges(document, positions) {
                return __awaiter(this, void 0, void 0, function* () {
                    const textDocument = { uri: document.uri };
                    return yield Promise.resolve(client.sendRequest('$/textDocument/selectionRanges', { textDocument, positions }));
                });
            }
        }));
        ...
        context.subscriptions.push(tagClosing_1.activateTagClosing(tagRequestor, filetypes, 'html.autoClosingTags'));
    }, _e => {
        // noop
    });
...
function activate(context) {
    return __awaiter(this, void 0, void 0, function* () {
        const config = coc_nvim_1.workspace.getConfiguration('html');
        const enable = config.get('enable', true);
        if (enable === false)
            return;
        const filetypes = config.get('filetypes', ['html', 'handlebars', 'htmldjango', 'blade']);
        let activated = false;
        for (let doc of coc_nvim_1.workspace.textDocuments) {
        ...
        if (!activated) {
            let disposable = coc_nvim_1.workspace.onDidOpenTextDocument(e => {
                if (activated || !filetypes.includes(e.languageId))
                    return;
                disposable.dispose();
                activated = true;
                realActivate(context, filetypes);
...
function activateTagClosing(tagProvider, supportedLanguages, configName) {
    ...
    coc_nvim_1.workspace.onDidChangeTextDocument(event => {
        const document = coc_nvim_1.workspace.getDocument(event.textDocument.uri);
        if (!document) {
            return;
        }
    ...
    disposables.push(coc_nvim_1.workspace.registerAutocmd({
        event: ['BufEnter'],
        request: false,
    ...
    function updateEnabledState() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!coc_nvim_1.workspace.getConfiguration(undefined, document.uri).get(configName)) {
                return;
            }
            isEnabled = true;
        });
    ...
    function onDidChangeTextDocument(document, changes) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!vscode_languageserver_protocol_1.Range.is(lastChange['range']) || !lastChange.text) {
                return;
            }
            ...
            timeout = setTimeout(() => __awaiter(this, void 0, void 0, function* () {
                ...
                tagProvider(document, position).then((text) => __awaiter(this, void 0, void 0, function* () {
                    if (text && isEnabled) {
                        const doc = yield coc_nvim_1.workspace.document;
                        if (!doc) {
                            return;
                        ...
                        if (document.uri === activeDocument.uri && activeDocument.version === version) {
                            coc_nvim_1.snippetManager.insertSnippet(text, false, vscode_languageserver_protocol_1.Range.create(position, position))
                                .catch(() => {
                                // noop
                            });
                        }
